...
|**creationDate** | **OffsetDateTime** | Domain creation timestamp (ISO 8601). Returns an empty string when enrichment data is unavailable. |  |
|**expirationDate** | **OffsetDateTime** | Domain expiration timestamp (ISO 8601). Returns an empty string when enrichment data is unavailable. |  |
|**updatedDate** | **OffsetDateTime** | Last WHOIS update timestamp (ISO 8601). Returns an empty string when enrichment data is unavailable. |  |
