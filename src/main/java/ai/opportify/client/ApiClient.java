...
import ai.opportify.client.auth.Authentication;
import ai.opportify.client.auth.HttpBasicAuth;
import ai.opportify.client.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.opportify.ai/insights/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("opportifyToken", new ApiKeyAuth("header", "x-opportify-token"));
    ...
    private void init() {
        ...
        setUserAgent("Opportify.ai/1.0.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.opportify.ai/insights/v1
     ...
     * @return a {@link ai.opportify.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws ai.opportify.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws ai.opportify.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws ai.opportify.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws ai.opportify.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws ai.opportify.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws ai.opportify.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws ai.opportify.client.ApiException If fails to update the parameters
     */
     ...
     * @throws ai.opportify.client.ApiException If fail to serialize the request body object into a string
     */
