...
public class AnalyzeIp400ResponseError extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AnalyzeIp400ResponseError.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AnalyzeIp400ResponseError.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AnalyzeIp400ResponseError' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<AnalyzeIp400ResponseError>() {
                @Override
                public void write(JsonWriter out, AnalyzeIp400ResponseError value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: IPVALIDATIONFAILED, MALFORMEDREQUEST1");
                }

                @Override
                public AnalyzeIp400ResponseError read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        AnalyzeIp400ResponseError ret = new AnalyzeIp400ResponseError();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for AnalyzeIp400ResponseError: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AnalyzeIp400ResponseError() {
        super("oneOf", Boolean.FALSE);
    }

    public AnalyzeIp400ResponseError(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return AnalyzeIp400ResponseError.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * IPVALIDATIONFAILED, MALFORMEDREQUEST1
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be IPVALIDATIONFAILED, MALFORMEDREQUEST1");
    }
     ...
     * IPVALIDATIONFAILED, MALFORMEDREQUEST1
     *
     * @return The actual instance (IPVALIDATIONFAILED, MALFORMEDREQUEST1)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * @throws IOException if the JSON Element is invalid with respect to AnalyzeIp400ResponseError
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for AnalyzeIp400ResponseError with oneOf schemas: IPVALIDATIONFAILED, MALFORMEDREQUEST1. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of AnalyzeIp400ResponseError given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AnalyzeIp400ResponseError
     * @throws IOException if the JSON string is invalid with respect to AnalyzeIp400ResponseError
     */
    public static AnalyzeIp400ResponseError fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AnalyzeIp400ResponseError.class);
    }

    /**
     * Convert an instance of AnalyzeIp400ResponseError to an JSON string
     *
     * @return JSON string
     */
