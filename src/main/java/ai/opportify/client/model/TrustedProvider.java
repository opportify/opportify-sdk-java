...
public class TrustedProvider {
  ...
  public TrustedProvider isKnownProvider(@javax.annotation.Nonnull Boolean isKnownProvider) {
   ...
   */
  @javax.annotation.Nonnull
  public Boolean getIsKnownProvider() {
    return isKnownProvider;
  }

  public void setIsKnownProvider(@javax.annotation.Nonnull Boolean isKnownProvider) {
    this.isKnownProvider = isKnownProvider;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrustedProvider trustedProvider = (TrustedProvider) o;
    return Objects.equals(this.isKnownProvider, trustedProvider.isKnownProvider) &&
        Objects.equals(this.provider, trustedProvider.provider) &&
        Objects.equals(this.providerType, trustedProvider.providerType) &&
        Objects.equals(this.description, trustedProvider.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isKnownProvider, provider, providerType, description);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrustedProvider {\n");
    sb.append("    isKnownProvider: ").append(toIndentedString(isKnownProvider)).append("\n");
  ...
  static {
    ...
    openapiFields.add("isKnownProvider");
    ...
    openapiRequiredFields.add("isKnownProvider");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrustedProvider
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrustedProvider.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrustedProvider is not found in the empty JSON string", TrustedProvider.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrustedProvider.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrustedProvider` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrustedProvider.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrustedProvider.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrustedProvider' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrustedProvider> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrustedProvider.class));

       return (TypeAdapter<T>) new TypeAdapter<TrustedProvider>() {
           @Override
           public void write(JsonWriter out, TrustedProvider value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrustedProvider read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrustedProvider given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrustedProvider
   * @throws IOException if the JSON string is invalid with respect to TrustedProvider
   */
  public static TrustedProvider fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrustedProvider.class);
  }

  /**
   * Convert an instance of TrustedProvider to an JSON string
   *
   * @return JSON string
   */
