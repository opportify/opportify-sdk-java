...
public class AdminContact {
  ...
  public AdminContact contactId(@javax.annotation.Nullable String contactId) {
  ...
  public AdminContact contactType(@javax.annotation.Nullable String contactType) {
  ...
  public AdminContact name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AdminContact address(@javax.annotation.Nullable List<String> address) {
    this.address = address;
    return this;
  }

  public AdminContact addAddressItem(String addressItem) {
  ...
  public AdminContact phone(@javax.annotation.Nullable List<String> phone) {
    this.phone = phone;
    return this;
  }

  public AdminContact addPhoneItem(String phoneItem) {
    if (this.phone == null) {
  ...
  public AdminContact fax(@javax.annotation.Nullable List<String> fax) {
    this.fax = fax;
    return this;
  }

  public AdminContact addFaxItem(String faxItem) {
    if (this.fax == null) {
  ...
  public AdminContact email(@javax.annotation.Nullable List<String> email) {
    this.email = email;
    return this;
  }

  public AdminContact addEmailItem(String emailItem) {
    if (this.email == null) {
  ...
  public boolean equals(Object o) {
    ...
    AdminContact adminContact = (AdminContact) o;
    return Objects.equals(this.contactId, adminContact.contactId) &&
        Objects.equals(this.contactType, adminContact.contactType) &&
        Objects.equals(this.name, adminContact.name) &&
        Objects.equals(this.address, adminContact.address) &&
        Objects.equals(this.phone, adminContact.phone) &&
        Objects.equals(this.fax, adminContact.fax) &&
        Objects.equals(this.email, adminContact.email);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminContact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminContact is not found in the empty JSON string", AdminContact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminContact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminContact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminContact.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminContact>() {
           @Override
           public void write(JsonWriter out, AdminContact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminContact read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminContact given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminContact
   * @throws IOException if the JSON string is invalid with respect to AdminContact
   */
  public static AdminContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminContact.class);
  }

  /**
   * Convert an instance of AdminContact to an JSON string
   *
   * @return JSON string
   */
