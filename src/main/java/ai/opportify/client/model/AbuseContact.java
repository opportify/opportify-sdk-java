...
public class AbuseContact {
  ...
  public AbuseContact contactId(@javax.annotation.Nullable String contactId) {
  ...
  public AbuseContact contactType(@javax.annotation.Nullable String contactType) {
  ...
  public AbuseContact name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AbuseContact address(@javax.annotation.Nullable List<String> address) {
    this.address = address;
    return this;
  }

  public AbuseContact addAddressItem(String addressItem) {
  ...
  public AbuseContact phone(@javax.annotation.Nullable List<String> phone) {
    this.phone = phone;
    return this;
  }

  public AbuseContact addPhoneItem(String phoneItem) {
    if (this.phone == null) {
  ...
  public AbuseContact fax(@javax.annotation.Nullable List<String> fax) {
    this.fax = fax;
    return this;
  }

  public AbuseContact addFaxItem(String faxItem) {
    if (this.fax == null) {
  ...
  public AbuseContact email(@javax.annotation.Nullable List<String> email) {
    this.email = email;
    return this;
  }

  public AbuseContact addEmailItem(String emailItem) {
    if (this.email == null) {
  ...
  public boolean equals(Object o) {
    ...
    AbuseContact abuseContact = (AbuseContact) o;
    return Objects.equals(this.contactId, abuseContact.contactId) &&
        Objects.equals(this.contactType, abuseContact.contactType) &&
        Objects.equals(this.name, abuseContact.name) &&
        Objects.equals(this.address, abuseContact.address) &&
        Objects.equals(this.phone, abuseContact.phone) &&
        Objects.equals(this.fax, abuseContact.fax) &&
        Objects.equals(this.email, abuseContact.email);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbuseContact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbuseContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbuseContact is not found in the empty JSON string", AbuseContact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbuseContact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbuseContact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbuseContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbuseContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbuseContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbuseContact.class));

       return (TypeAdapter<T>) new TypeAdapter<AbuseContact>() {
           @Override
           public void write(JsonWriter out, AbuseContact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbuseContact read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbuseContact given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbuseContact
   * @throws IOException if the JSON string is invalid with respect to AbuseContact
   */
  public static AbuseContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbuseContact.class);
  }

  /**
   * Convert an instance of AbuseContact to an JSON string
   *
   * @return JSON string
   */
