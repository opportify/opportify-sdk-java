...
public class BatchAnalyzeEmails402Response extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BatchAnalyzeEmails402Response.class.isAssignableFrom(type.getRawType())) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<BatchAnalyzeEmails402Response>() {
                @Override
                public void write(JsonWriter out, BatchAnalyzeEmails402Response value) throws IOException {
                ...
                @Override
                public BatchAnalyzeEmails402Response read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        BatchAnalyzeEmails402Response ret = new BatchAnalyzeEmails402Response();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for BatchAnalyzeEmails402Response: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BatchAnalyzeEmails402Response() {
        super("oneOf", Boolean.FALSE);
    }

    public BatchAnalyzeEmails402Response(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return BatchAnalyzeEmails402Response.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to BatchAnalyzeEmails402Response
     */
    ...
    /**
     * Create an instance of BatchAnalyzeEmails402Response given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of BatchAnalyzeEmails402Response
     * @throws IOException if the JSON string is invalid with respect to BatchAnalyzeEmails402Response
     */
    public static BatchAnalyzeEmails402Response fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, BatchAnalyzeEmails402Response.class);
    }

    /**
     * Convert an instance of BatchAnalyzeEmails402Response to an JSON string
     *
     * @return JSON string
     */
