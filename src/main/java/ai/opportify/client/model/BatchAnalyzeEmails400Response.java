...
public class BatchAnalyzeEmails400Response extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<MALFORMEDREQUEST> adapterMALFORMEDREQUEST3 = gson.getDelegateAdapter(this, TypeToken.get(MALFORMEDREQUEST.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<BatchAnalyzeEmails400Response>() {
                ...
                public void write(JsonWriter out, BatchAnalyzeEmails400Response value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof MALFORMEDREQUEST) {
                        JsonElement element = adapterMALFORMEDREQUEST3.toJsonTree((MALFORMEDREQUEST)value.getActualInstance());
     ...
     */
    public MALFORMEDREQUEST getMALFORMEDREQUEST3() throws ClassCastException {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for BatchAnalyzeEmails400Response with oneOf schemas: INVALIDDATA, MALFORMEDREQUEST. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
