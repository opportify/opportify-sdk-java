...
public class BatchAnalyzeIps400Response extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BatchAnalyzeIps400Response.class.isAssignableFrom(type.getRawType())) {
            ...
            final TypeAdapter<INVALIDDATA> adapterINVALIDDATA1 = gson.getDelegateAdapter(this, TypeToken.get(INVALIDDATA.class));

            return (TypeAdapter<T>) new TypeAdapter<BatchAnalyzeIps400Response>() {
                @Override
                public void write(JsonWriter out, BatchAnalyzeIps400Response value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof INVALIDDATA) {
                        JsonElement element = adapterINVALIDDATA1.toJsonTree((INVALIDDATA)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                ...
                @Override
                public BatchAnalyzeIps400Response read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        BatchAnalyzeIps400Response ret = new BatchAnalyzeIps400Response();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for BatchAnalyzeIps400Response: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BatchAnalyzeIps400Response() {
        super("oneOf", Boolean.FALSE);
    }

    public BatchAnalyzeIps400Response(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return BatchAnalyzeIps400Response.schemas;
    }
     ...
     */
    public INVALIDDATA getINVALIDDATA1() throws ClassCastException {
     ...
     * @throws IOException if the JSON Element is invalid with respect to BatchAnalyzeIps400Response
     */
    ...
    /**
     * Create an instance of BatchAnalyzeIps400Response given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of BatchAnalyzeIps400Response
     * @throws IOException if the JSON string is invalid with respect to BatchAnalyzeIps400Response
     */
    public static BatchAnalyzeIps400Response fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, BatchAnalyzeIps400Response.class);
    }

    /**
     * Convert an instance of BatchAnalyzeIps400Response to an JSON string
     *
     * @return JSON string
     */
