...
public class AnalyzeEmail200Response {
  ...
  public static final String SERIALIZED_NAME_EMAIL_AUTO_CORRECTED_FROM = "emailAutoCorrectedFrom";
  @SerializedName(SERIALIZED_NAME_EMAIL_AUTO_CORRECTED_FROM)
  @javax.annotation.Nullable
  private String emailAutoCorrectedFrom;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.emailAddress, analyzeEmail200Response.emailAddress) &&
        ...
        Objects.equals(this.emailAutoCorrectedFrom, analyzeEmail200Response.emailAutoCorrectedFrom) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(emailAddress, emailProvider, emailType, isDeliverable, isCatchAll, isMailboxFull, isReachable, isFormatValid, emailCorrection, emailAutoCorrectedFrom, addressSignals, emailDNS, riskReport, domain);
  }
  ...
  public String toString() {
    ...
    sb.append("    emailAutoCorrectedFrom: ").append(toIndentedString(emailAutoCorrectedFrom)).append("\n");
  ...
  static {
    ...
    openapiFields.add("emailAutoCorrectedFrom");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("emailAutoCorrectedFrom") != null && !jsonObj.get("emailAutoCorrectedFrom").isJsonNull()) && !jsonObj.get("emailAutoCorrectedFrom").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `emailAutoCorrectedFrom` to be a primitive type in the JSON string but got `%s`", jsonObj.get("emailAutoCorrectedFrom").toString()));
      }
