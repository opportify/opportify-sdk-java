...
public class BatchAnalyzeIpsRequest {
  ...
  public BatchAnalyzeIpsRequest() {
  }

  public BatchAnalyzeIpsRequest ips(@javax.annotation.Nonnull List<String> ips) {
    this.ips = ips;
    return this;
  }

  public BatchAnalyzeIpsRequest addIpsItem(String ipsItem) {
    if (this.ips == null) {
  ...
  public boolean equals(Object o) {
    ...
    BatchAnalyzeIpsRequest batchAnalyzeIpsRequest = (BatchAnalyzeIpsRequest) o;
    return Objects.equals(this.ips, batchAnalyzeIpsRequest.ips) &&
        Objects.equals(this.name, batchAnalyzeIpsRequest.name) &&
        Objects.equals(this.enableAI, batchAnalyzeIpsRequest.enableAI);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ips, name, enableAI);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchAnalyzeIpsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchAnalyzeIpsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchAnalyzeIpsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchAnalyzeIpsRequest is not found in the empty JSON string", BatchAnalyzeIpsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchAnalyzeIpsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchAnalyzeIpsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchAnalyzeIpsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchAnalyzeIpsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchAnalyzeIpsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchAnalyzeIpsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchAnalyzeIpsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchAnalyzeIpsRequest>() {
           @Override
           public void write(JsonWriter out, BatchAnalyzeIpsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchAnalyzeIpsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchAnalyzeIpsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchAnalyzeIpsRequest
   * @throws IOException if the JSON string is invalid with respect to BatchAnalyzeIpsRequest
   */
  public static BatchAnalyzeIpsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchAnalyzeIpsRequest.class);
  }

  /**
   * Convert an instance of BatchAnalyzeIpsRequest to an JSON string
   *
   * @return JSON string
   */
