...
public class BatchAnalyzeEmailsRequest {
  ...
  public BatchAnalyzeEmailsRequest() {
  }

  public BatchAnalyzeEmailsRequest emails(@javax.annotation.Nonnull List<String> emails) {
    this.emails = emails;
    return this;
  }

  public BatchAnalyzeEmailsRequest addEmailsItem(String emailsItem) {
    if (this.emails == null) {
  ...
  public boolean equals(Object o) {
    ...
    BatchAnalyzeEmailsRequest batchAnalyzeEmailsRequest = (BatchAnalyzeEmailsRequest) o;
    return Objects.equals(this.emails, batchAnalyzeEmailsRequest.emails) &&
        Objects.equals(this.name, batchAnalyzeEmailsRequest.name) &&
        Objects.equals(this.enableAI, batchAnalyzeEmailsRequest.enableAI) &&
        Objects.equals(this.enableAutoCorrection, batchAnalyzeEmailsRequest.enableAutoCorrection);
  }

  @Override
  public int hashCode() {
    return Objects.hash(emails, name, enableAI, enableAutoCorrection);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchAnalyzeEmailsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchAnalyzeEmailsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchAnalyzeEmailsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchAnalyzeEmailsRequest is not found in the empty JSON string", BatchAnalyzeEmailsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchAnalyzeEmailsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchAnalyzeEmailsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchAnalyzeEmailsRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("emails") == null) {
        throw new IllegalArgumentException("Expected the field `emails` to be an array in the JSON string but got `null`");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchAnalyzeEmailsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchAnalyzeEmailsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchAnalyzeEmailsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchAnalyzeEmailsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchAnalyzeEmailsRequest>() {
           @Override
           public void write(JsonWriter out, BatchAnalyzeEmailsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchAnalyzeEmailsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchAnalyzeEmailsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchAnalyzeEmailsRequest
   * @throws IOException if the JSON string is invalid with respect to BatchAnalyzeEmailsRequest
   */
  public static BatchAnalyzeEmailsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchAnalyzeEmailsRequest.class);
  }

  /**
   * Convert an instance of BatchAnalyzeEmailsRequest to an JSON string
   *
   * @return JSON string
   */
