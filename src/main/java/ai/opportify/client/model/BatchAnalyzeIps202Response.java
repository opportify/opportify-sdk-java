...
public class BatchAnalyzeIps202Response {
  ...
  public BatchAnalyzeIps202Response() {
  }

  public BatchAnalyzeIps202Response jobId(@javax.annotation.Nullable String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public BatchAnalyzeIps202Response status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchAnalyzeIps202Response batchAnalyzeIps202Response = (BatchAnalyzeIps202Response) o;
    return Objects.equals(this.jobId, batchAnalyzeIps202Response.jobId) &&
        Objects.equals(this.name, batchAnalyzeIps202Response.name) &&
        Objects.equals(this.status, batchAnalyzeIps202Response.status) &&
        Objects.equals(this.statusDescription, batchAnalyzeIps202Response.statusDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchAnalyzeIps202Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchAnalyzeIps202Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchAnalyzeIps202Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchAnalyzeIps202Response is not found in the empty JSON string", BatchAnalyzeIps202Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchAnalyzeIps202Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchAnalyzeIps202Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchAnalyzeIps202Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchAnalyzeIps202Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchAnalyzeIps202Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchAnalyzeIps202Response.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchAnalyzeIps202Response>() {
           @Override
           public void write(JsonWriter out, BatchAnalyzeIps202Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchAnalyzeIps202Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchAnalyzeIps202Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchAnalyzeIps202Response
   * @throws IOException if the JSON string is invalid with respect to BatchAnalyzeIps202Response
   */
  public static BatchAnalyzeIps202Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchAnalyzeIps202Response.class);
  }

  /**
   * Convert an instance of BatchAnalyzeIps202Response to an JSON string
   *
   * @return JSON string
   */
